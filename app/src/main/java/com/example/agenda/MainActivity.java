...
public class MainActivity extends AppCompatActivity {
    ...
    private void signIn() {
        ...
        //createPendingResult(123, signInIntent, 0);
        //onActivityResult(123, 123, signInIntent);
    ...
    public void changeAgendaActivity()
    {
        //Intent changeLoad = new Intent(getApplicationContext(), LoadActivity.class);
        //startActivity(changeLoad);
